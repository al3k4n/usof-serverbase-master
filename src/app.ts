...
// }).unless({
//     path: [
//         {url: 'http://localhost:8080/api/user/register/', methods: ["GET", "POST", "OPTIONS"]},
//         {url: 'http://localhost:8080/docs/', methods: ["GET"]},
//         // '/api/user/login/',
//         // '/confirm'
//     ]
// }))
...
app.get('/confirm/:token', async (req, res) => {
    const relatedUser = await User.findOne({verification: req.params.token})
    if (relatedUser) {
